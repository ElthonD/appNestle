...
def load_df():
    ...
    rEmbarques = r'./data/Salidas Modelo 2023.xlsx'
...
try:
    ...
    st.markdown("<h2 style='text-align: left;'>Carga de Trabajo Operativa del Centro de Monitoreo para Grupo Modelo</h2>", unsafe_allow_html=True)
    ...
    st.write(""" 
    La finalidad de este módulo es consultar el histórico de salidas de Grupo Modelo y realizar seguimiento a la carga de trabajo. Pasos a seguir para este módulo:
    1. Seleccionar el **División** del cuál desea obtener información de salidas y carga de trabajo. Seleccionando el checkbox, puede seleccionar todas las divisiones de Grupo Modelo.
    2. Seleccionar el **Mes** del cuál desea obtener información de salidas y carga de trabajo. Seleccionando el checkbox, puede seleccionar ttodas las divisiones de Grupo Modelo.
       """)
